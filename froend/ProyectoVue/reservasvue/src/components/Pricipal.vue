...
// Computed property para mapear el estado del usuario desde Vuex
...
<template>
	<header>
		...
		<span class="navegar__Usuario">
			...
			<img class="perfil" src="../assets/IMG/foto.png" alt="Usuario-perfil" @click="toggleDropdown" />
		</span>
...
body {
	background-image: url(..\assets\IMG\french-restaurant-2506490_1280.jpg);
...
.redirect-button:hover {
	background-color: #e5533d;
	/* Un tono más oscuro del color principal */
	transform: translateY(-5px);
}

.redirect-button:active {
	background-color: #c44d2c;
	/* Un tono aún más oscuro al hacer clic */
